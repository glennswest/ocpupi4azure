...
az network private-dns record-set srv add-record -g $1 -z $2  -n _etcd-server-ssl._tcp -t bootstrap-0.${2} -p 1 -w 1 -r 2380
az network private-dns record-set srv add-record -g $1 -z $2  -n _etcd-server-ssl._tcp -t master1.${2} -p 1 -w 1 -r 2380
az network private-dns record-set srv add-record -g $1 -z $2  -n _etcd-server-ssl._tcp -t master2.${2} -p 1 -w 1 -r 2380
az network private-dns record-set srv add-record -g $1 -z $2  -n _etcd-server-ssl._tcp -t master3.${2} -p 1 -w 1 -r 2380
